...
onAuthStateChanged(auth, (user) => {
    ...
    if (user) {
        ...
        class="group flex items-center gap-3 px-5 py-2.5 bg-white rounded-full hover:bg-slate-100 transition-all duration-300 shadow-lg shadow-black/20 border border-slate-200">
        ...
        <span class="text-[11px] text-slate-700 group-hover:text-black font-bold uppercase tracking-wider">Увійти через Google</span>
        </button>`;
